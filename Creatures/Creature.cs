abstract class Creature {
    ...
    public virtual void Attack(Creature opponent, int additionalDamage)
    {
        var oldHealth = opponent.Health;
        opponent.Health -= Damage + additionalDamage;
        var h = opponent.Health < 0 ? 0 : opponent.Health;
        ...
        Tools.PrintBattleInfo($"{selectedHero.Name} attacks {opponent.Name} ({h}/{oldHealth}) with {Damage + additionalDamage} dmg!");
    }
}